...
import type { AsyncPreconditionContainerReturn } from '../utils/preconditions/IPreconditionContainer';
...
export class PreconditionStore extends Store<Precondition> {
	...
	public async run(message: Message, command: Command, context: PreconditionContext = {}): AsyncPreconditionContainerReturn {
