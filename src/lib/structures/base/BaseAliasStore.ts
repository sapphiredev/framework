import { AliasStore, Piece, PieceContextExtras, Store, StoreOptions } from '@sapphire/pieces';
...
export class BaseAliasStore<T extends BaseAliasPiece> extends AliasStore<T> {
	...
	public constructor(client: Client, Ctor: Constructor<T>, options: StoreOptions<T>) {
		super(Ctor, {
